                ...
                <?php
                    if(isset($_POST['category']) && isset($_POST['submitCat'])){
                        try{
                            ...
                            $stmt=$conn->query("SELECT * from shopify.product WHERE category='".$category."'");
                            echo "<center>";
        ...
        <?php
                    ...
                    <?php
                        if(isset($_POST['pid'])){
                            try{
                                $pid=$_POST['pid'];
                                $stmt=$conn->query("SELECT * from shopify.product WHERE pid='".$pid."'");
                                echo "<center>";
                    ...
                    <?php
                        if(isset($_POST['sellerid'])){
                            try{
                                ...
                                $stmt=$conn->query("SELECT * from shopify.product WHERE sellerid='".$sellerid."'");
                                echo "<center>";
