    ...
    <form method="POST">
        ...
        <?php
            if ( isset($_POST['submit'])) {
                try{
                    $sql="UPDATE shopify.users U SET U.walletBalance='".$_POST['walletBalance']."'+U.walletBalance WHERE U.userid='".$_SESSION['userid']."'";
                ...
                $sql2="UPDATE shopify.buyer U SET U.walletBalance=".$_POST['walletBalance']."+U.walletBalance WHERE U.buyerid='".$_SESSION['userid']."'";
                try{
