...
<body>
    ...
    <div>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            Price*(in Rs.) <br>
            <span style="color:blue;"> <b>IMPORTANT</b>  You will get 95% of it in your wallet when the product gets sold!</span><br>
        ...
        <?php
            ...
            if(isset($_POST['pid']))
            $pid=$_POST['pid'];
            if(isset($_POST['pid']) && isset($_POST['pname']) && isset($_POST['price']) && isset($_POST['category']) && isset($_POST['description']) && isset($_POST['inStock'])){
                try{
                    $sql="INSERT INTO shopify.product (sellerid,pid,pname,price,category,description,inStock) VALUES (:sellerid,:pid,:pname,:price,:category,:description,:inStock)";
            ...
            if(isset($_FILES) && isset($_POST['pid'])){              
                ...
                try{
                    $sql="INSERT INTO shopify.productImages (sellerid,pid,imageNo,imageLocation) VALUES (:sellerid,:pid,:imageNo,:imageLocation)";
            $stmt=$conn->prepare($sql);
            $stmt->execute(array(
                ':sellerid'=>$_SESSION['userid'],
                ':pid' =>$_POST['pid'],
