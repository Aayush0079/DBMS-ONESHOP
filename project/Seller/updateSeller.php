...
<body>
    ...
    <?php
        ...
        if ( isset($_POST['sname']) && isset($_POST['walletBalance']) && isset($_POST['occupation']) && isset($_POST['address']) && isset($_POST['contactNo'])) {
            $sql="UPDATE shopify.users U SET U.uname='".$_POST['sname']."',U.walletBalance='".$_POST['walletBalance']."'+U.walletBalance,
            ...
            $sql2="UPDATE shopify.seller U SET U.sname='".$_POST['sname']."',U.walletBalance='".$_POST['walletBalance']."'+U.walletBalance,
