...
<div class="topnav" id="myTopnav">   
        ...
        <a href="sellers.php" class="active">View Sellers</a>
    ...
    <?php
        ...
        $stmt=$conn->query("SELECT B.sellerID,B.sname,B.email,B.walletBalance,B.occupation,B.address,B.sellerRating,B.contactNo FROM shopify.seller B");
        $count=$stmt->rowCount();
        if($count==0){
