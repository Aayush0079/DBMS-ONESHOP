...
<div class="topnav" id="myTopnav">   
        ...
        <a href="products.php" class="active">View Products</a>
    ...
    <?php
            try{ 
                $stmt=$conn->query("SELECT * FROM shopify.payment P, shopify.buyer B, shopify.pays K,shopify.seller S WHERE P.pid='".$_SESSION['pid']."' AND K.pid='".$_SESSION['pid']."' AND P.buyerid=B.buyerid AND K.sellerID=S.sellerID");
                echo "";
